...
from tensorflow.keras.layers import concatenate, Conv2DTranspose, BatchNormalization, Input
...
def SqueezeUNet(num_classes=None, deconv_ksize=3, dropout=0.5, activation='sigmoid'):
